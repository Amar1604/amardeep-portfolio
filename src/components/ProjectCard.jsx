...
export const ProjectCard = ({ project, onSelect }) => {
  ...
  return (
    ...
    >
      ...
      {/* Scrollable Content Body with 100% untruncated content */}
      <div
        className="project-card-scroll-body card-layer-depth-2"
        data-cursor="SCROLL"
      ...
      >
        ...
        <button
          ...
          title="Zoom & View Full-Screen Architecture Dossier"
          data-cursor="ZOOM"
        >
          <span>Zoom Card &rarr;</span>
        </button>
      </div>
    </div>
  );
